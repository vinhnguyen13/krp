...
/**
 * This is the model class for table "cms_article_translation".
 *
 * The followings are the available columns in table 'cms_article_translation':
 * @property integer $id
...
class ArticleTranslation extends CActiveRecord
{
	...
	{
		return 'cms_article_translation';
	}
