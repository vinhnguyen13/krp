...
<div style="text-align:right;"><?php echo CHtml::link('Create new Section', array('//news/section/create')); ?></div>
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
				'name' => 'status',
				'filter' => CHtml::dropDownList('Section[status]',$model->status, array('1' => 'Enable', '2' => 'Disable')),
