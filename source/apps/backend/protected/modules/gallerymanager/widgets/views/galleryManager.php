...
<?php echo CHtml::openTag('div', $this->htmlOptions); ?>
    ...
    <div class="modal hide editor-modal">
        <div class="modal-header">
            <a class="close" onclick="$('.editor-modal').hide();" data-dismiss="modal">×</a>
        ...
        <div class="modal-footer">
            ...
            <a href="#" onclick="$('.editor-modal').hide();" class="btn" data-dismiss="modal"><?php echo Yii::t('galleryManager.main', 'Close')?></a>
        </div>
    </div>
    <div class="overlay">
