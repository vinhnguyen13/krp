    	...
    	<table width="563" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:12px; color:#565656;">
          ...
          <tr>
            <td style="background:#FFF; padding:0 40px 10px 40px; font-weight: normal;" align="left" valign="top">
            	<p style="font-size:14px; font-weight: normal; margin-bottom: 5px;"><b><b><?php echo (isset($to)) ? $to : null;?></b> thân mến,</p>
                <p style="line-height:18px; font-weight: normal; margin-bottom: 5px;"><b><?php echo (isset($name)) ? $name : null;?></b>  muốn chia sẻ với bạn một bài viết thú vị trên KelReport:</p>
