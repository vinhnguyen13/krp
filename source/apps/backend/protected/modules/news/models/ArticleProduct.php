 ...
 */
class ArticleProduct extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('product_name, product_price', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('article_id, product_name, product_price', 'safe', 'on'=>'search'),
		);
	}
