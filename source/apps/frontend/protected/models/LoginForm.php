...
class LoginForm extends CFormModel
{
	...
	{
		return array(
			'username'=> Lang::t('general', 'Email'),
			'password'=>Lang::t('general', 'Password'),
	...
	public function authenticate($attribute,$params)
	{
		if(!$this->hasErrors())
		{
		    ...
		    {
		        $profile = YumProfile::model()->findByAttributes(array('email'=>$username));
	...
	public function loginWithoutPassword($username)
	{
	    if($this->_identity===null)
	    {
	        $this->_identity=new UserIdentity($username,null);
