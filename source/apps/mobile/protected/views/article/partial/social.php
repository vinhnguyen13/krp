...
?>
<li class="icon-like action">
	<a data-type="like" data-enable="<?php echo $like_enable;?>" class="social icon-touch <?php echo $like;?>" href="javascript:void(0);" rel="<?php echo Yii::app()->createUrl('//product/excute', array('type'=>'like'));?>"><span class="icon-common">&nbsp;</span></a>
</li>
<li class="icon-unlike action">
	<a data-type="dislike" data-enable="<?php echo $hate_enable;?>" class="social icon-touch <?php echo $hate;?>" href="javascript:void(0);" rel="<?php echo Yii::app()->createUrl('//product/excute', array('type'=>'hate'));?>"><span class="icon-common">&nbsp;</span></a>
</li>
<li class="icon-bouth action">
	<a data-type="bou" data-enable="<?php echo $bought_enable;?>" class="social icon-touch <?php echo $bought;?>" href="javascript:void(0);" rel="<?php echo Yii::app()->createUrl('//product/excute', array('type'=>'bought'));?>"><span class="icon-common">&nbsp;</span></a>
</li>
<!--  
